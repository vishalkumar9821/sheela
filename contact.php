			...
			<div class="row">
				<div class="col-lg-6">
					<div class="xs-contact-form-wraper">
						...
						<form action="tata_contact.php" method="POST"  class="xs-contact-form contact-form-v2">
							...
							<div class="input-group">
								<input type="number" name="phone" id="xs-email" class="form-control" placeholder="Enter Your Phone No.....">
								<div class="input-group-append">
							...
							<div class="input-group massage-group">
								<textarea name="message" placeholder="Enter Your Message....." id="xs-massage" class="form-control" cols="30" rows="10"></textarea>
								<div class="input-group-append">
